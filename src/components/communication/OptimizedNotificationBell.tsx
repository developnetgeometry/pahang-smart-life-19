...
import { Bell, BellRing, Check, MessageSquare, AlertTriangle, Calendar, Users } from 'lucide-react';
...
const OptimizedNotificationBell = React.memo(() => {
  ...
  const getNotificationColor = useMemo(() => (type?: string, priority?: string) => {
  ...
  const handleNotificationClick = async (notification: NotificationData) => {
    ...
    const routes = {
      chat_messages: `/communication-hub?room=${notification.reference_id}`,
      event: '/',
      complaint: '/my-complaints',
      default: '/'
    };

    const route = routes[notification.reference_table as keyof typeof routes] || 
...
export default OptimizedNotificationBell;