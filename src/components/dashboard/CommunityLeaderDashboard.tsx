  ...
  const communityPolls = [
    {
      title:
        language === "en"
          ? "Preferred time for community meetings"
          : "Masa pilihan untuk mesyuarat komuniti",
      responses: 45,
      status: "active",
      endDate: "2024-02-20",
      options: [
    ...
    },
    {
      title:
        language === "en"
          ? "Next community event suggestion"
          : "Cadangan acara komuniti seterusnya",
      responses: 32,
      status: "closed",
      endDate: "2024-02-10",
  ...
  const recentSuggestions = [
    {
      ...
      suggestion:
        language === "en"
          ...
          : "Pencahayaan yang lebih baik di kawasan parkir",
    ...
    },
    {
      ...
      suggestion:
        language === "en"
          ? "More cultural celebration events"
          : "Lebih banyak acara perayaan budaya",
      category: "Events",
      upvotes: 8,
      status: "approved",
    },
      ...
      <div>
        <h1 className="text-3xl font-bold text-foreground">
          {language === "en"
            ...
            : "Papan Pemuka Ketua Komuniti"}
        </h1>
        <p className="text-muted-foreground">
          {language === "en"
            ? "Community engagement and event management"
            : "Penglibatan komuniti dan pengurusan acara"}
        </p>
      </div>
            ...
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {language === "en"
                  ...
                  : "Ringkasan Penglibatan Komuniti"}
              </CardTitle>
            </CardHeader>
            <CardContent>
                  ...
                  <div className="space-y-2">
                    {poll.options.map((option, optIndex) => (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          <Progress
                            value={(option.votes / poll.responses) * 100}
                            className="w-12 h-1"
                          />
              ...
              >
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs text-muted-foreground mt-1">
                    ...
                    <Progress
                      value={
                        (opportunity.volunteers / opportunity.needed) * 100
                      }
