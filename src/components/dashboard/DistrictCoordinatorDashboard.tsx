  ...
  const pendingActions = [
    {
      ...
      message:
        language === "en"
          ? "2 community admin reports pending"
          : "2 laporan admin komuniti belum selesai",
      priority: "medium",
      count: 2,
    },
    {
      ...
      message:
        language === "en"
          ? "Facility maintenance scheduling needed"
          : "Penjadualan penyelenggaraan kemudahan diperlukan",
      priority: "medium",
      count: 1,
    },
  ];
      ...
      <div>
        <h1 className="text-3xl font-bold text-foreground">
          {language === "en"
            ...
            : "Papan Pemuka Penyelaras Daerah"}
        </h1>
        <p className="text-muted-foreground">
          {language === "en"
            ? "Pahang Prima North - Regional coordination and oversight"
            : "Pahang Prima North - Penyelarasan dan pengawasan serantau"}
        </p>
      </div>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="flex items-center gap-2">
                ...
                {language === "en"
                  ? "District Operations Status"
                  : "Status Operasi Daerah"}
              </CardTitle>
            </CardHeader>
            <CardContent>
            ...
            >
              <div className="flex items-center gap-3 min-w-0 flex-1">
                ...
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-sm truncate sm:whitespace-normal">
                    {action.type}
                  </p>
              ...
              >
                ...
                <div className="shrink-0 w-full sm:w-auto flex flex-row sm:flex-col items-stretch sm:items-end gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <Progress
                      value={community.satisfaction * 20}
