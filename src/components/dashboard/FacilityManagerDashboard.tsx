  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const activeFacilities =
        facilities?.filter((f) => f.is_available)?.length || 0;
    ...
    <div className="space-y-6 p-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Manage facilities, bookings, and maintenance operations
        </p>
      </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-green-600">
                  RM {stats.monthlyRevenue.toFixed(0)}
                </p>
              </div>
      ...
      <Tabs defaultValue="overview" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Latest facility management activities
                </CardDescription>
              </CardHeader>
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            ...
                            {activity.priority && (
                              <Badge
                                variant={
                                  getPriorityColor(activity.priority) as any
                                }
                                className="text-xs"
                              >
                                {activity.priority}
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Current status of all facilities
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                    ...
                    >
                      ...
                      <div className="text-right">
                        <p className="text-sm text-muted-foreground">
                          Today: {facility.utilizationToday}%
                        </p>
                        <Progress
                          value={facility.utilizationToday}
                          className="w-20 h-2"
                        />
                      </div>
                    </div>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Manage all community facilities
                </CardDescription>
              </div>
              <Button asChild>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Access comprehensive facility management tools including
                configuration, availability management, and performance
                analytics.
              </p>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Oversee facility bookings and reservations
                </CardDescription>
              </div>
              <Button asChild>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Monitor all facility bookings, approve reservations, manage
                conflicts, and track utilization rates across all facilities.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="maintenance" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Schedule preventive maintenance, track repair requests, manage
                service providers, and ensure optimal facility conditions.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="complaints" className="space-y-6">
          <Card>
            ...
            <CardContent>
              <p className="text-muted-foreground">
                Access the dedicated complaint center to view, track, and manage
                all facility-related complaints including maintenance issues,
                booking problems, and amenity concerns.
              </p>
