...
export function ResidentDashboard() {
  ...
  const communityUpdates = [
    {
      ...
      title:
        language === "en"
          ...
          : "Penyelenggaraan Kolam Dijadualkan",
      message:
        language === "en"
          ? "Pool maintenance scheduled for tomorrow 9AM-12PM"
          : "Penyelenggaraan kolam dijadualkan esok 9AM-12PM",
      time: "2 hours ago",
      priority: "medium",
      details: {
        description:
          language === "en"
            ? "The swimming pool will undergo routine maintenance and cleaning. The pool area will be closed to ensure safety during the maintenance period."
            : "Kolam renang akan menjalani penyelenggaraan rutin dan pembersihan. Kawasan kolam akan ditutup untuk memastikan keselamatan semasa tempoh penyelenggaraan.",
        duration:
          language === "en"
            ? "3 hours (9:00 AM - 12:00 PM)"
            : "3 jam (9:00 AM - 12:00 PM)",
        affectedAreas:
          language === "en"
            ? "Swimming pool, Pool deck, Changing rooms"
            : "Kolam renang, Geladak kolam, Bilik tukar pakaian",
        contact:
          language === "en"
            ? "Management Office: +60 3-1234 5678"
            : "Pejabat Pengurusan: +60 3-1234 5678",
      },
    },
    {
      type: "event",
      ...
      message:
        language === "en"
          ...
          : "Sertai kami untuk sambutan Tahun Baru Cina - 12 Feb, Dewan Komuniti",
      time: "1 day ago",
      priority: "low",
      details: {
        description:
          language === "en"
            ? "Join our community in celebrating Chinese New Year! We will have traditional performances, delicious food, and fun activities for the whole family."
            : "Sertai komuniti kami dalam meraikan Tahun Baru Cina! Kami akan mengadakan persembahan tradisional, makanan lazat, dan aktiviti menyeronokkan untuk seluruh keluarga.",
        dateTime:
          language === "en"
            ? "February 12, 2024 - 7:00 PM to 10:00 PM"
            : "12 Februari 2024 - 7:00 PM hingga 10:00 PM",
        location:
          language === "en"
            ? "Community Hall, Level G"
            : "Dewan Komuniti, Aras G",
        activities:
          language === "en"
            ? "Lion dance, Traditional music, Food stalls, Games for children"
            : "Tarian singa, Muzik tradisional, Gerai makanan, Permainan untuk kanak-kanak",
        contact:
          language === "en"
            ? "Event Coordinator: Sarah +60 12-345 6789"
            : "Penyelaras Acara: Sarah +60 12-345 6789",
      },
    },
    {
      type: "announcement",
      ...
      message:
        language === "en"
          ...
          : "Protokol keselamatan baharu dilaksanakan untuk akses pelawat",
      time: "3 days ago",
      priority: "high",
      details: {
        description:
          language === "en"
            ? "Enhanced security measures have been implemented to improve the safety and security of our community. All visitors must now follow the new registration process."
            : "Langkah keselamatan yang dipertingkatkan telah dilaksanakan untuk meningkatkan keselamatan komuniti kami. Semua pelawat kini mesti mengikut proses pendaftaran baharu.",
        effectiveDate:
          language === "en"
        ...
        newRequirements:
          language === "en"
            ? "Photo ID required, Pre-registration via app/phone, Security escort for contractors"
            : "ID foto diperlukan, Pra-pendaftaran melalui aplikasi/telefon, Pengiring keselamatan untuk kontraktor",
        officeHours:
          language === "en"
            ? "Security Office: 24/7 available"
            : "Pejabat Keselamatan: Tersedia 24/7",
        contact:
          language === "en"
            ? "Security Hotline: +60 3-9876 5432"
            : "Talian Hotline Keselamatan: +60 3-9876 5432",
      },
    },
  ];
  ...
  const allQuickActions = [
    ...
    },
    {
      ...
      description:
        language === "en" ? "Connect with neighbors" : "Berhubung dengan jiran",
      icon: MessageSquare,
    ...
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">
          {language === "en"
            ? `Welcome back, ${user?.display_name || "Resident"}`
            : `Selamat kembali, ${user?.display_name || "Penduduk"}`}
        </h1>
        <p className="text-muted-foreground">
          {language === "en"
            ? `${user?.district || "Your Community"} - Unit A-5-12`
            : `${user?.district || "Komuniti Anda"} - Unit A-5-12`}
        </p>
      </div>
          ...
          {selectedUpdate && (
            <div className="space-y-4">
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                ...
                {selectedUpdate.time}
                <Badge
                  variant={getPriorityColor(selectedUpdate.priority) as any}
                >
