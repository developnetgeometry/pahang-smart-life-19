            ...
            {districtPerformance.map((district, index) => (
              ...
              >
                ...
                <div className="shrink-0 w-full sm:w-auto flex flex-row sm:flex-col items-stretch sm:items-end gap-2">
                  <Progress
                    value={district.satisfaction * 20}
                      ...
                      <Tabs defaultValue="overview" className="w-full">
                        <TabsList className="grid w-full grid-cols-4">
                          ...
                          <TabsTrigger value="trends">
                            {language === "en" ? "Trends" : "Trend"}
                          </TabsTrigger>
                          <TabsTrigger value="facilities">
                            {language === "en" ? "Facilities" : "Kemudahan"}
                          </TabsTrigger>
                          <TabsTrigger value="demographics">
                            {language === "en" ? "Demographics" : "Demografi"}
                          </TabsTrigger>
                        </TabsList>
                              ...
                              <CardContent>
                                <ResponsiveContainer width="100%" height={200}>
                                  <PieChart>
                                    <Pie
                                      data={
                                        getDistrictDetailedData(district.name)
                                          .issueTypes
                                      }
                                      cx="50%"
                                      cy="50%"
                            ...
                            <CardContent>
                              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                ...
                                <div className="text-center p-4 bg-muted rounded-lg">
                                  ...
                                  <div className="text-sm text-muted-foreground">
                                    {language === "en"
                                      ? "Adult to Senior Ratio"
                                      : "Nisbah Dewasa kepada Warga Emas"}
                                  </div>
                                </div>
                                <div className="text-center p-4 bg-muted rounded-lg">
                                  <div className="text-2xl font-bold text-primary">
