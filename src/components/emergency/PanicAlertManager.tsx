        ...
        <div>
          <h2 className="text-2xl font-bold text-foreground">
            {language === "en"
              ...
              : "Pengurusan Amaran Panik"}
          </h2>
          <p className="text-muted-foreground">
            {language === "en"
              ? "Monitor and respond to emergency alerts"
              : "Pantau dan respon kepada amaran kecemasan"}
          </p>
        </div>
              ...
              {alerts
                ...
                .map((alert) => {
                  ...
                  return (
                    <div
                      key={alert.id}
                      className="bg-white dark:bg-gray-900 p-4 rounded-lg border border-red-200 dark:border-red-800"
                    >
                      <div className="flex items-center justify-between">
