...
export function RecurringBookingManager() {
  ...
  const toggleBookingStatus = async (
    ...
    try {
      ...
      toast.success(
        `Recurring booking ${newStatus === "active" ? "activated" : "paused"}`
      );
      fetchData();
    } catch (error) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage automated recurring facility bookings
          </p>
        </div>
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setFormData({
                        ...formData,
                        recurrence_interval: parseInt(value),
                      })
                    }
                  >
                    <SelectTrigger>
              ...
              <CardContent>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm mb-4">
                  ...
                  <div>
                    ...
                    <div>
                      {new Date(booking.next_booking_date).toLocaleDateString()}
                    </div>
                  </div>
                  <div>
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    <Switch
                      ...
                      onCheckedChange={() =>
                        toggleBookingStatus(booking.id, booking.status)
                      }
                    />
