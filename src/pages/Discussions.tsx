  ...
  useEffect(() => {
    const fetchDiscussions = async () => {
      try {
        ...
        const transformedDiscussions: Discussion[] = (data || []).map(
          (discussion) => ({
            id: discussion.id,
            title: discussion.title,
            content: discussion.content,
            author:
              discussion.author_profile?.full_name ||
  ...
  const handlePostComment = async () => {
    ...
    try {
      ...
      const newCommentObj: Comment = {
        id: data.id,
        author:
          data.profiles?.full_name || data.profiles?.email || "Anonymous User",
        author_id: data.author_id,
        content: data.content,
        timestamp: "just now",
        likes: 0,
          ...
          <CardHeader>
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-1">
                ...
                <span>
                  {t.lastActivity}: {selectedDiscussion.lastActivity}
                </span>
              </div>
            </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-muted-foreground">
                    {language === "en"
                      ...
                      : "Belum ada komen. Jadilah yang pertama berkomen!"}
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setNewDiscussion((prev) => ({ ...prev, category: value }))
                  }
                >
                  <SelectTrigger>
            ...
            <CardContent className="pt-0">
              <div className="flex items-center justify-between text-sm text-muted-foreground">
                ...
                <div className="flex items-center gap-1">
                  <Clock className="h-4 w-4" />
                  <span>
                    {t.lastActivity}: {discussion.lastActivity}
                  </span>
                </div>
              </div>
            </CardContent>
