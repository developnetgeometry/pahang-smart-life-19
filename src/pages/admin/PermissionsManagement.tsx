...
export default function PermissionsManagement() {
  ...
  const handleAddRole = async () => {
    ...
    try {
      const { error } = await supabase.from("enhanced_user_roles").insert({
        user_id: userId,
  ...
  const getPermissionValue = (
    ...
    return permission
      ? (permission[permissionType as keyof RolePermission] as boolean)
      : false;
  };
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Select
                      value={selectedRole}
                      onValueChange={(value) =>
                        setSelectedRole(value as EnhancedUserRole | "")
                      }
                    >
                      <SelectTrigger>
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Level {getRoleLevel(userRole.role)} • Assigned on{" "}
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <Switch
                      ...
                      onCheckedChange={() =>
                        handleToggleRoleStatus(userRole.id, userRole.is_active)
                      }
                    />
                    <Button
                      variant="outline"
                    ...
                    >
                      <div className="flex items-center justify-center gap-2">
                        <div
                          ...
                          style={{
                            backgroundColor: getRoleColor(userRole.role),
                          }}
                        />
                        {userRole.role
                          .replace("_", " ")
