          ...
          <Card>
            <CardContent className="p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-2xl font-bold">{applicationStats.under_review}</p>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-3 mb-2">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-muted-foreground">
                              {app.business_type} • Contact: {app.contact_person}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-wrap gap-2 mb-3">
                          ...
                          <Badge className={PRIORITY_COLORS[app.priority as keyof typeof PRIORITY_COLORS]}>
                        ...
                        <div className="mb-3">
                          ...
                          <div className="flex flex-wrap gap-1">
                            {app.service_categories.slice(0, 3).map(category => (
                      ...
                      <div className="flex flex-col gap-2 ml-4">
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => navigate(`/admin/service-providers/review/${app.id}`)}
                        >
            ...
            {providers.length === 0 ? (
              <Card>
                <CardContent className="p-8 text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">No Active Providers</h3>
                  <p className="text-muted-foreground">
