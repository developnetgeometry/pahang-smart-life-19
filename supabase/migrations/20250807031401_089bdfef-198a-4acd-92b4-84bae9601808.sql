...
-- Insert sample CCTV cameras with fixed locations
INSERT INTO public.cctv_cameras (name, location, ip_address, is_active, district_id) VALUES
('Camera 1', 'Main Entrance', '192.168.1.101'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Prima')),
('Camera 2', 'Parking Area', '192.168.1.102'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Prima')),
('Camera 3', 'Playground', '192.168.1.103'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Suria')),
('Camera 4', 'Swimming Pool', '192.168.1.104'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Suria')),
('Camera 5', 'Common Area', '192.168.1.105'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Indah')),
('Camera 6', 'Main Entrance', '192.168.1.106'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Indah')),
('Camera 7', 'Parking Area', '192.168.1.107'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Sejahtera')),
('Camera 8', 'Playground', '192.168.1.108'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Sejahtera')),
('Camera 9', 'Swimming Pool', '192.168.1.109'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Harmoni')),
('Camera 10', 'Common Area', '192.168.1.110'::inet, true, (SELECT id FROM public.districts WHERE name = 'Taman Harmoni'));

-- Insert sample sensors with fixed types and locations
INSERT INTO public.sensors (name, type, location, is_active, district_id) VALUES
('Temperature Sensor 1', 'temperature', 'Community Hall', true, (SELECT id FROM public.districts WHERE name = 'Taman Prima')),
('Humidity Sensor 1', 'humidity', 'Swimming Pool', true, (SELECT id FROM public.districts WHERE name = 'Taman Prima')),
('Air Quality Sensor 1', 'air_quality', 'Parking Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Suria')),
('Noise Sensor 1', 'noise', 'Garden Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Suria')),
('Motion Sensor 1', 'motion', 'Common Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Indah')),
('Temperature Sensor 2', 'temperature', 'Community Hall', true, (SELECT id FROM public.districts WHERE name = 'Taman Indah')),
('Humidity Sensor 2', 'humidity', 'Swimming Pool', true, (SELECT id FROM public.districts WHERE name = 'Taman Sejahtera')),
('Air Quality Sensor 2', 'air_quality', 'Parking Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Sejahtera')),
('Noise Sensor 2', 'noise', 'Garden Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Harmoni')),
('Motion Sensor 2', 'motion', 'Common Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Harmoni')),
('Smoke Sensor 1', 'smoke', 'Community Hall', true, (SELECT id FROM public.districts WHERE name = 'Taman Prima')),
('Temperature Sensor 3', 'temperature', 'Garden Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Suria')),
('Humidity Sensor 3', 'humidity', 'Common Area', true, (SELECT id FROM public.districts WHERE name = 'Taman Indah')),
('Air Quality Sensor 3', 'air_quality', 'Community Hall', true, (SELECT id FROM public.districts WHERE name = 'Taman Sejahtera')),
('Motion Sensor 3', 'motion', 'Swimming Pool', true, (SELECT id FROM public.districts WHERE name = 'Taman Harmoni'));