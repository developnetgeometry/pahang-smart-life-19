-- Check what columns exist in visitors table and insert basic data
INSERT INTO visitors (host_id, visitor_name, visitor_phone, purpose, visit_date, visit_time_start, visit_time_end, status, district_id, notes) VALUES
