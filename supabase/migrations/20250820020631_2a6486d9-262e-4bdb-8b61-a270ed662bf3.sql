-- Create visitors table and data (without redefining enum)
...
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies WHERE tablename = 'visitors'
  ) THEN
...
-- Clear existing visitor data and insert sample data
