-- Assign proper roles to test users based on their email addresses using the correct app_role type
...
SELECT 
  ...
  CASE 
    ...
    WHEN p.email = 'securitynorth@test.com' THEN 'security'::app_role
