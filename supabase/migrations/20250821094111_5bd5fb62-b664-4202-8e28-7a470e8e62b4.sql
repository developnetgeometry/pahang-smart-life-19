...
-- Insert sample complaint records
...
VALUES
  ...
  ('Noise Complaint', 'Loud music from unit 12-A during late hours', 'noise', (SELECT id FROM profiles ORDER BY RANDOM() LIMIT 1), (SELECT id FROM districts LIMIT 1), 'high', 'investigating', 'Block B Unit 12-A'),
