...
VALUES
  ...
  ('Security Patrol Schedule', 'Updated security patrol schedule is now available at the management office.', 'general', (SELECT id FROM profiles LIMIT 1), (SELECT id FROM districts LIMIT 1), false, true),
