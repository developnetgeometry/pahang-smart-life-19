...
-- Insert additional sample facilities with proper images if they don't exist
INSERT INTO public.facilities (name, description, location, capacity, amenities, image)
VALUES 
  ('Children''s Playground', 'Safe playground area for children with modern equipment', 'Recreation Area', 25, ARRAY['Swings', 'Slides', 'Climbing frames', 'Soft play area'], 'playground-facility.jpg'),
  ('Prayer Hall', 'Prayer hall for Muslim community members', 'Block C, Ground Floor', 100, ARRAY['Prayer mats', 'Ablution area', 'Air conditioning'], 'prayer-hall-facility.jpg'),
  ('Community Garden', 'Beautiful garden area for relaxation and community activities', 'Central Area', 50, ARRAY['Walking paths', 'Benches', 'Landscaping'], 'garden-facility.jpg')
