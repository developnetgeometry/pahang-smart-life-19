...
INSERT INTO districts (id, name, code, state_id, created_at) VALUES
('11111111-1111-1111-1111-111111111111', 'Kuantan', 'KTN', '22222222-2222-2222-2222-222222222222', now()),
('33333333-3333-3333-3333-333333333333', 'Shah Alam', 'SA', '44444444-4444-4444-4444-444444444444', now())
ON CONFLICT (id) DO NOTHING;

-- Insert sample states (if not exists)
INSERT INTO states (id, name, code, created_at) VALUES
('22222222-2222-2222-2222-222222222222', 'Pahang', 'PAH', now()),
('44444444-4444-4444-4444-444444444444', 'Selangor', 'SEL', now())
ON CONFLICT (id) DO NOTHING;
