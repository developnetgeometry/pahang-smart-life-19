...
-- Update role hierarchy to include new roles (using available levels)
INSERT INTO role_hierarchy (role, level, permission_level, display_name, description, color_code)
VALUES 
  ('spouse', 11, 'standard_access', 'Spouse', 'Spouse of primary resident with limited access', '#8B5CF6'),
  ('tenant', 0, 'limited_access', 'Tenant', 'Tenant with restricted access to community features', '#6B7280')
