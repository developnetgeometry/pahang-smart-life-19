-- Insert sample marketplace items without seller_type to avoid constraint issues
INSERT INTO marketplace_items (
  seller_id, title, description, price, image, category, 
  condition, stock_quantity, location, 
  is_available, is_active, district_id, created_at
) VALUES
('bfe88021-d76b-4f65-8b43-1b879ad4617a', 'Vintage Motorcycle Helmet', 
 ...
 true, true, 'f44ef553-d0af-40e0-a9fd-aa741b5fd2fc', now()),
