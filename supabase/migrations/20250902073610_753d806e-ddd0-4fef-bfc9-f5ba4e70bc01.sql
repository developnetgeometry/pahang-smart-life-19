...
INSERT INTO visitors (
  visitor_name, visitor_phone, visitor_ic, vehicle_plate, visit_date, visit_time, 
...
SET qr_code_data = jsonb_build_object(
  ...
  'qr_code', 'QR_' || UPPER(LEFT(visitor_name, 3)) || '_' || TO_CHAR(NOW(), 'YYYYMMDD') || '_' || LEFT(id::text, 8),
  'generated_at', NOW()
)
