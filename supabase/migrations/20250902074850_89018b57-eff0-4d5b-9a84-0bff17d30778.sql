-- Enhanced get_enabled_modules_for_user function that considers user roles and permissions
  ...
  role_modules AS (
    ...
    FROM (
      VALUES 
        ...
        -- MANAGEMENT MODULES (Facility Manager and above)
        ...
        -- MAINTENANCE MODULES (Maintenance Staff and above)
        ('maintenance', 'Maintenance Requests', 'services', ARRAY['maintenance_staff', 'facility_manager', 'community_admin', 'district_coordinator', 'state_admin']::text[]),
