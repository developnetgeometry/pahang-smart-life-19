-- First, update all profiles to use the correct district ID for Pahang Prima North
UPDATE profiles 
SET district_id = 'f44ef553-d0af-40e0-a9fd-aa741b5fd2fc'
WHERE district_id = '00000000-0000-0000-0000-000000000001';

-- Update enhanced_user_roles table as well if needed
...
-- Add communities for districts that don't have any
