-- Add RLS policies for the new workflow tables (Fixed)

-- First, add the missing RLS policies without the problematic column references
...
-- RLS Policies for Service Requests (Fixed to avoid column reference issues)
