...
-- Add guest role to role_hierarchy if it doesn't exist
...
-- Update the profiles table query to use 'id' column instead of 'user_id'  
-- (This was already fixed in the edge function but let's ensure consistency)
